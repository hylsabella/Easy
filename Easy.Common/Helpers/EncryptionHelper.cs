...
namespace Easy.Common.Helpers
{
    public static class EncryptionHelper
    {
        ...
        /// <returns>密文</returns>
        public static string RSA加密ByXml(string content, string publicKey, Encoding encoding = null)
        {
        ...
        /// <param name="encoding">编码方式</param>
        /// <returns>明文</returns>
        public static string RSA解密ByXml(string content, string privateKey, Encoding encoding = null)
        {
            encoding = encoding ?? Encoding.UTF8;
        ...
        private static RSACryptoServiceProvider CreateRsaProviderFromPrivateKey(string privateKey)
        {
            ...
            using (var memoryStream = new MemoryStream(privateKeyBits))
            {
        ...
        private static RSACryptoServiceProvider CreateRsaProviderFromPublicKey(string publickey)
        {
            ...
            using (var memoryStream = new MemoryStream(publickeyBits))
            {
                using (var binr = new BinaryReader(memoryStream))
                {
                    ushort twobytes = binr.ReadUInt16();
        ...
        public static string DES加密(string content, string key)
        {
            ...
            using (var md5CryptoService = new MD5CryptoServiceProvider())
            {
                ...
                {
                    using (var crytpoTransform = tripleDESCryptoService.CreateEncryptor())
                    {
        ...
        public static string DES解密(string content, string key)
        {
            ...
            using (var md5CryptoService = new MD5CryptoServiceProvider())
            {
                ...
                {
                    using (var crytpoTransform = tripleDESCryptoService.CreateDecryptor())
                    {
        ...
        public static string AES加密(string content, string key)
        {
            ...
            using (var managed = new RijndaelManaged())
            {
                ...
                using (ICryptoTransform cTransform = managed.CreateEncryptor())
                {
        ...
        public static string AES解密(string content, string key)
        {
            ...
            using (var managed = new RijndaelManaged())
            {
                ...
                using (ICryptoTransform cTransform = managed.CreateDecryptor())
                {
                    byte[] resultArray = cTransform.TransformFinalBlock(toEncryptArray, 0, toEncryptArray.Length);
